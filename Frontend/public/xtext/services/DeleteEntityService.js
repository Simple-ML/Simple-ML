...
define(['xtext/services/XtextService', 'jquery'], function(XtextService, jQuery) {
     ...
     */
    function DeleteEntitySerice(serviceUrl, resourceId) {
        this.initialize(serviceUrl, 'deleteEntity', resourceId);
        this._completionCallbacks = [];
    };

    DeleteEntitySerice.prototype = new XtextService();

    DeleteEntitySerice.prototype.onComplete = function(xhr, textStatus) {
     ...
     */
    DeleteEntitySerice.prototype.addCompletionCallback = function(callback, params) {
        this._completionCallbacks.push({callback: callback, params: params});
    }

    DeleteEntitySerice.prototype.invoke = function(editorContext, params, deferred) {
        ...
        var serverData = {
            deleteEntityDTO: params.deleteEntityDTO
        };
    ...
    DeleteEntitySerice.prototype._getSuccessCallback = function(editorContext, params, deferred) {
