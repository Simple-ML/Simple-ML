...
define(['xtext/services/XtextService', 'jquery'], function(XtextService, jQuery) {
     ...
     */
    function DeleteAssociationService(serviceUrl, resourceId) {
        this.initialize(serviceUrl, 'deleteAssociation', resourceId);
        this._completionCallbacks = [];
    };

    DeleteAssociationService.prototype = new XtextService();

    DeleteAssociationService.prototype.onComplete = function(xhr, textStatus) {
     ...
     */
    DeleteAssociationService.prototype.addCompletionCallback = function(callback, params) {
        this._completionCallbacks.push({callback: callback, params: params});
    }

    DeleteAssociationService.prototype.invoke = function(editorContext, params, deferred) {
    ...
    DeleteAssociationService.prototype._getSuccessCallback = function(editorContext, params, deferred) {
    ...
    return DeleteAssociationService;
});
