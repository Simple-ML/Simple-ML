  ...
  return (
    <div onContextMenu={handleClick} style={{ cursor: 'context-menu' }}>
      ...
      >
        ...
        <MenuItem onClick={handleClose}>Load Trained Model</MenuItem>
        <MenuItem onClick={handleClose}>Join with...</MenuItem>
        <MenuItem onClick={handleClose}>Split</MenuItem>
        <MenuItem onClick={handleClose}>Train</MenuItem>
        <MenuItem onClick={handleClose}>More Options</MenuItem>
        <MenuItem onClick={handleClose}><VisibilityIcon/> Quick help</MenuItem>
      </Menu>
    </div>
  );
}
