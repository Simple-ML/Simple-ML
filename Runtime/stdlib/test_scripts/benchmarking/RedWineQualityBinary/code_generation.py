...
def dsl_code_generation(metric_names,
                        model_name: str,
                        dataset_name: str,
                        target_var: str,
                    parameters: dict,
    ...
    metric_import_string = ''.join(['import simpleml.metrics.'+metr_name+'\n' for metr_name in metric_names])
...
if __name__ == "__main__":
    ...
    dsl_code = dsl_code_generation(metric_names=['meanAbsoluteError'],
                                   model_name='LinearRegression',
                                   dataset_name='WhiteWineQualityBinary',
                                   target_var='quality',
                                   parameters={},
