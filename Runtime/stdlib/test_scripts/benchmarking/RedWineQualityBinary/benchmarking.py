...
from simpleml.dataset import StandardScaler, loadDataset

# Workflow steps ---------------------------------------------------------------
from simpleml.metrics import accuracy, balancedAccuracy, meanAbsoluteError, r2
from simpleml.model.supervised.classification import SupportVectorMachineClassifier
from simpleml.model.supervised.classification._tree import (
...
def exampleWorkflow():
    ...
    models_zoo = {
        ...
        "RidgeRegression": {"model": RidgeRegression, "param": {}},
        "DecisionTreeRegressor": {
                    ...
                    [
                        [
                            ...
                            *[
                                ...
                                for metric_func in metrics_zoo["metric"]
                            ],
                            source_code,
                            dsl_code,
                        ]
