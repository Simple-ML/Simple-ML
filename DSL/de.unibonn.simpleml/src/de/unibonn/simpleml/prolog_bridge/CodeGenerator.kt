...
//        if (eob.contains(handleIntAsInt(f.arguments[0]))) return eob[handleIntAsInt(f.arguments[0])]
//
//        val key = handleIntAsInt(f.arguments[0])
//
...
//                eob[key] = e
//
//                e.name = handleStringAsString(f.arguments[2])
//                addList(e.imports as EList<EObject>, handleList(f.arguments[3]) as List<EObject>)
//                addList(e.members as EList<EObject>, handleList(f.arguments[4]) as List<EObject>)
//
//                return e
//            }
//            "simpleml:workflowT" -> {
...
//                addList(e.body.statements as EList<EObject>, handleList(f.arguments[3]) as List<EObject>)
//
//                return e
//            }
//            "simpleml:importT" -> {
...
//                eob[key] = e
//
//                e.importedNamespace = handleStringAsString(f.arguments[2])
//                e.alias = handleStringAsString(f.arguments[3])
//
//                return e
//            }
//            "simpleml:doStatementT" -> {
//                val e = SimpleMLFactory.eINSTANCE.createSmlDoStatement()
//                eob[key] = e
//
//                e.expression = handleInt(f.arguments[2]) as SmlExpression
//                e.assigneeList = SimpleMLFactory.eINSTANCE.createSmlDoStatementAssigneeList()
//                addList(e.assigneeList.assignees as EList<EObject>, handleList(f.arguments[3]) as List<EObject>)
//
//                return e
//            }
...
//
//                e.name = handleStringAsString(f.arguments[2])
//                addList(e.annotations as EList<EObject>, handleList(f.arguments[3]) as List<EObject>)
//                addList(e.modifiers as EList<EObject>, handleList(f.arguments[4]) as List<EObject>)
//
//                return e
//            }
//            "simpleml:callT" -> {
...
//                eob[key] = e
//
//                e.receiver = handleInt(f.arguments[3]) as SmlExpression
//                e.argumentList = SimpleMLFactory.eINSTANCE.createSmlArgumentList()
//                addList(e.argumentList.arguments as EList<EObject>, handleList(f.arguments[4]) as List<EObject>)
//                e.typeArgumentList = SimpleMLFactory.eINSTANCE.createSmlTypeArgumentList()
//
//                //TODO das hier auslagern, wird wohl häufiger benutzt
//                val l = handleList(f.arguments[5])
//                if (l != null) addList(e.typeArgumentList.typeArguments as EList<EObject>, l as List<EObject>)
...
//
//                e.receiver = handleInt(f.arguments[3]) as SmlExpression
//                e.member = handleInt(f.arguments[4]) as SmlReference
//                e.isNullable = handleBoolean(f.arguments[5])
//
//                return e
//            }
//            "simpleml:referenceT" -> {
...
//                eob[key] = e
//
//                e.declaration = handleInt(f.arguments[3]) as SmlDeclaration?
//
//                return e
//            }
...
//                eob[key] = e
//
//                e.operator = handleStringAsString(f.arguments[3])
//                e.leftOperand = handleInt(f.arguments[4]) as SmlTypeParameter
//                e.rightOperand = handleInt(f.arguments[5]) as SmlType
//
//                return e
//            }
...
//                eob[key] = e
//
//                e.variance = handleStringAsString(f.arguments[2])
//
//                return e
//            }
//            "simpleml:argumentT" -> {
...
//                eob[key] = e
//
//                e.parameter = handleInt(f.arguments[3]) as SmlParameter?
//                e.value = handleInt(f.arguments[4]) as SmlExpression?
//
//                return e
//            }
//            "simpleml:parameterT" -> {
...
//
//                e.name = handleStringAsString(f.arguments[2])
//                e.type = handleInt(f.arguments[3]) as SmlType?
//                e.defaultValue = handleInt(f.arguments[4]) as SmlExpression?
//                e.isVararg = handleBoolean(f.arguments[5])
//
//                return e
//            }
...
//                eob[key] = e
//
//                e.value = handleStringAsString(f.arguments[3])
//
//                return e
//            }
...
//                eob[key] = e
//
//                e.value = handleIntAsInt(f.arguments[3])
//
//                return e
//            }
...
//                eob[key] = e
//
//                e.value = handleDoubleAsDouble(f.arguments[3])
//
//                return e
//            }
...
//                eob[key] = e
//
//                e.isTrue = handleBoolean(f.arguments[3])
//
//                return e
//            }
//            "simpleml:nullT" -> {
...
//                eob[key] = e
//
//                e.variance = handleStringAsString(f.arguments[3])
//                e.type = handleInt(f.arguments[4]) as SmlType?
//
//                return e
//            }
...
//
//                e.operator = handleStringAsString(f.arguments[3])
//                e.operand = handleInt(f.arguments[4]) as SmlExpression?
//
//                return e
//            }
...
//                eob[key] = e
//
//                e.leftOperand = handleInt(f.arguments[3]) as SmlExpression?
//                e.operator = handleStringAsString(f.arguments[4])
//                e.rightOperand = handleInt(f.arguments[5]) as SmlExpression?
//
//                return e
//            }
//            "simpleml:lambdaT" -> {
...
//                eob[key] = e
//
//                e.parameterList = handleInt(f.arguments[4]) as SmlParameterList?
//                e.body = SimpleMLFactory.eINSTANCE.createSmlBlock()
//                addList(e.body.statements as EList<EObject>, handleList(f.arguments[5]) as List<EObject>)
//
//                return e
//            }
...
//                addList(e.parameterList.parameters as EList<EObject>, handleList(f.arguments[2]) as List<EObject>)
//                e.resultList = SimpleMLFactory.eINSTANCE.createSmlResultList()
//                addList(e.resultList.results as EList<EObject>, handleList(f.arguments[3]) as List<EObject>)
//
//                return e
//            }
...
//                eob[key] = e
//
//                e.member = handleInt(f.arguments[2]) as SmlNamedType?
//                e.receiver = handleInt(f.arguments[3]) as SmlType?
//
//                return e
//            }
//            "simpleml:namedTypeT" -> {
...
//                eob[key] = e
//
//                e.declaration = handleInt(f.arguments[2]) as SmlNamedTypeDeclaration?
//                e.typeArgumentList = SimpleMLFactory.eINSTANCE.createSmlTypeArgumentList()
//                addList(e.typeArgumentList.typeArguments as EList<EObject>, handleList(f.arguments[3]) as List<EObject>)
//                e.isNullable = handleBoolean(f.arguments[4])
//
//                return e
//            }
//            "simpleml:functionT" -> {
...
//                e.name = handleStringAsString(f.arguments[2])
//                e.parameterList = SimpleMLFactory.eINSTANCE.createSmlParameterList()
//                addList(e.parameterList.parameters as EList<EObject>, handleList(f.arguments[4]) as List<EObject>)
//                e.resultList = SimpleMLFactory.eINSTANCE.createSmlResultList()
//                addList(e.resultList.results as EList<EObject>, handleList(f.arguments[6]) as List<EObject>)
//                e.typeParameterConstraintList = SimpleMLFactory.eINSTANCE.createSmlTypeParameterConstraintList()
//                addList(e.typeParameterConstraintList.constraints as EList<EObject>, handleList(f.arguments[7]) as List<EObject>)
//                e.typeParameterList = SimpleMLFactory.eINSTANCE.createSmlTypeParameterList()
//                addList(e.typeParameterList.typeParameters as EList<EObject>, handleList(f.arguments[8]) as List<EObject>)
//
//                return e
//            }
//            "simpleml:wildcardT" -> {
...
//                eob[key] = e
//
//                e.result = handleInt(f.arguments[3]) as SmlResult?
//
//                return e
//            }
...
//                eob[key] = e
//
//                e.name = handleStringAsString(f.arguments[3])
//
//                return e
//            }
//            "simpleml:resultT" -> {
...
//
//                e.name = handleStringAsString(f.arguments[2])
//                e.parameterList = handleInt(f.arguments[3]) as SmlParameterList?
//
//                return e
//            }
...
//                eob[key] = e
//
//                e.annotation = handleInt(f.arguments[2]) as SmlAnnotation?
//                e.argumentList = handleInt(f.arguments[3]) as SmlArgumentList?
//
//                return e
//            }
...
//                addList(e.body.members as EList<EObject>, handleList(f.arguments[3]) as List<EObject>)
//                e.constructor = handleInt(f.arguments[4]) as SmlConstructor?
//                e.parentTypeList = SimpleMLFactory.eINSTANCE.createSmlParentTypeList()
//                addList(e.parentTypeList.parentTypes as EList<EObject>, handleList(f.arguments[5]) as List<EObject>)
//                e.typeParameterConstraintList = SimpleMLFactory.eINSTANCE.createSmlTypeParameterConstraintList()
//                addList(e.typeParameterConstraintList.constraints as EList<EObject>, handleList(f.arguments[6]) as List<EObject>)
//                e.typeParameterList = SimpleMLFactory.eINSTANCE.createSmlTypeParameterList()
//                addList(e.typeParameterList.typeParameters as EList<EObject>, handleList(f.arguments[7]) as List<EObject>)
//
//                return e
//            }
//            "simpleml:enumT" -> {
...
//                addList(e.body.instances as EList<EObject>, handleList(f.arguments[3]) as List<EObject>)
//
//                return e
//            }
...
//                eob[key] = e
//
//                e.typeParameter = handleInt(f.arguments[3]) as SmlTypeParameter?
//                e.value = handleInt(f.arguments[4]) as SmlTypeArgumentValue?
//
//                return e
//            }
//            "simpleml:unionTypeT" -> {
...
//
//                e.typeArgumentList = SimpleMLFactory.eINSTANCE.createSmlTypeArgumentList()
//                addList(e.typeArgumentList.typeArguments as EList<EObject>, handleList(f.arguments[2]) as List<EObject>)
//
//                return e
//            }
//            "simpleml:thisTypeT" -> {
