...
define(['xtext/services/XtextService', 'jquery'], function(XtextService, jQuery) {
     ...
     */
    function GetEntityAttributeDefinitionService(serviceUrl, resourceId) {
        this.initialize(serviceUrl, 'getEntityAttributeDefinition', resourceId);
        this._completionCallbacks = [];
    };

    GetEntityAttributeDefinitionService.prototype = new XtextService();

    GetEntityAttributeDefinitionService.prototype.onComplete = function(xhr, textStatus) {
     ...
     */
    GetEntityAttributeDefinitionService.prototype.addCompletionCallback = function(callback, params) {
        this._completionCallbacks.push({callback: callback, params: params});
    }

    GetEntityAttributeDefinitionService.prototype.invoke = function(editorContext, params, deferred) {
        ...
        var serverData = {
            ...
            classNameArray: params.classNameArray
        };
    ...
    return GetEntityAttributeDefinitionService;
});
