...
define(['xtext/services/XtextService', 'jquery'], function(XtextService, jQuery) {
     ...
     */
    function SetEntityAttributeService(serviceUrl, resourceId) {
        this.initialize(serviceUrl, 'setAttributes', resourceId);
        this._completionCallbacks = [];
    };

    SetEntityAttributeService.prototype = new XtextService();

    SetEntityAttributeService.prototype.onComplete = function(xhr, textStatus) {
     ...
     */
    SetEntityAttributeService.prototype.addCompletionCallback = function(callback, params) {
        this._completionCallbacks.push({callback: callback, params: params});
    }

    SetEntityAttributeService.prototype.invoke = function(editorContext, params, deferred) {
    ...
    SetEntityAttributeService.prototype._getSuccessCallback = function(editorContext, params, deferred) {
    ...
    return SetEntityAttributeService;
});
